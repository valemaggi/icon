...
grid = GridSearchCV(RandomForestClassifier(random_state=42), param_grid, cv=10, scoring='recall') 
...
plt.xlabel('Predetto')
plt.ylabel('Reale')
plt.savefig(f'./apprendimento_supervisionato/results/RF_matrix.png', bbox_inches='tight')


write_results("./apprendimento_supervisionato/accuracy_recall.txt", "RF", accuracy, recall)